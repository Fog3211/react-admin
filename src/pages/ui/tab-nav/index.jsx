...
import { Card, Tabs, Icon, Radio, Select, Spin } from 'antd';
import './index.less';
...
export default class TabNav extends Component {
	...
	render() {
		const { global_loading, mode, tabPosition } = this.state;
		return (
			<Spin spinning={global_loading} size="large">
				...
				<Card title="可调整位置标签页" className="tab-nav-box">
					<div style={{ marginBottom: 16 }}>
						标签位置：
						<Select value={tabPosition} onChange={this.changeTabPosition} dropdownMatchSelectWidth={false}>
